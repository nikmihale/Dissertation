\chapter{Задача А}\label{sec:ch4}
...
\begin{figure}[!htb]
\centering
\includegraphics[scale=0.5]{images/ch4/section2/domain_problemA.pdf}
...
\centering
\includegraphics[width=\textwidth]{images/ch4/section2/causticTypesBulletsDiagram.pdf}
    \caption{Области возможного движения бильярдной траектории.}
    \label{fig:pt9:_causticTypesBulletsDiagram}
\endminipage\hfill
\minipage{0.58\textwidth}
\centering
\includegraphics[width=\textwidth]{images/ch4/section2/problemAbifurcations.pdf}
...
%Доказательство будет основываться на соображениях, предложенных в \cite[\S 3]{fokicheva2015topological}.
...
\medskip
\textbf{Случай $D_4^2$. } Все звенья траектории содержатся в $\Omega_{out}$. Траектория отражается от обеих  границ эллиптического кольца  $\Omega_{out}$. Рассуждения, аналогичные предыдущему случаю, показывают, что в этом случае поверхностью уровня $\Xi=\const$ являются два дизъюнктных тора.
...
Отметим, что траектория, попадающая в точку листа, соответствующую вершине с внутренним углом $3\pi / 2$, не продолжается далее. %--- начало нового текста
...
Таких точек на поверхности четыре. %--- конец нового текста
...
$\widetilde{\Omega}_3 = \widetilde{\Omega}_{out, 3}^u \cup \widetilde{\Omega}_{in, 3} \cup \widetilde{\Omega}_{out, 1}^d$ и 
 ...
 \begin{figure}[!htb]
 \centering
\includegraphics[width=0.5\linewidth]{images/ch4/section2/problems_vectors_2.pdf}
...
Как и ранее, траектория, попадающая в точку листа, соответствующую вершине с внутренним углом $3\pi / 2$, не продолжается далее. %--- начало нового текста
Тем самым, поверхность имеет проколы, соответствующие точкам склеиваемых листов --- вершинам с внутренним углом величиной $3\pi / 2$. 
Таких точек на поверхности четыре.  %--- конец нового текста
...
\minipage{0.4\textwidth}
\centering
\includegraphics[width=\textwidth]{images/ch4/section2/ell_and_hyp2.pdf}
    \caption{Область $\widetilde{\Omega}_1$.}
    \label{fig:pt9:_ell_and_hyp_2}
\endminipage\hfill
\minipage{0.6\textwidth}
\centering
\includegraphics[width=0.8\textwidth]{images/ch4/section2/ell_and_hyp2_permutations.pdf}
...
\begin{figure}[!ht]
\centering
\includegraphics[width=0.4\textwidth]{images/ch4/section2/ell_and_hyp2_transformations.pdf}
...
\begin{figure}[!htb]
\centering
\includegraphics[width=0.9\textwidth]{images/ch4/section2/diagramPlusIrregular.pdf}
...
В симметричную ей дугу в нижней полуплоскости отображается общая для областей $\widetilde{\Omega}_{in, 1}$ и $\Omega_{out, 2}^d$ граница на поверхности $\Xi = \const$. Области $\widetilde{\Omega}_{in, 2}$ и $\Omega_{out, 1}^d$, $\widetilde{\Omega}_{in, 3}$ и $\Omega_{out, 4}^d$, а также $\widetilde{\Omega}_{in, 4}$ и $\Omega_{out, 3}^d$ отождествляются похожим образом.
...
\centering
\includegraphics[width=0.9\textwidth]{images/ch4/section2/atoms/domain_atom_ell_foc.pdf}
    \caption{Пример области $\widetilde{\Omega}_1$ для перестройки 1.}
    \label{fig:pt9:_domain_atom_ell_foc}
\endminipage\hfill
\minipage{0.45\textwidth}
\centering
\includegraphics[width=0.9\textwidth]{images/ch4/section2/atoms/atom1_result.pdf}
...
Остается отождествить два тора по этим кривым, тогда поверхность уровня $\Xi = \const$ представляет собой склейку двух торов по паре сплошных и паре штрихпунктирных кривых  (см. рис. \ref{fig:pt9:_atom1_result}). 
...
Пример области $\widetilde{\Omega}_1$ изображен на рис. \ref{fig:pt9:_domain_atom_foc_ell}.
 \begin{figure}[!htb]
\centering
\includegraphics[width=0.5\textwidth]{images/ch4/section2/atoms/domain_atom_foc_ell.pdf}
...
В этот сегмент прямой, в силу изложенных в \cite[\S 4]{fokicheva2015topological} соображений, проектируется общая граница для областей $\Omega_{in, 1}^u$ и $\Omega_{in, 2}^d$. Аналогично для пар областей $\Omega_{in, 2}^u$ и $\Omega_{in, 1}^d$, $\Omega_{in, 3}^u$ и $\Omega_{in, 4}^d$ и для пары $\Omega_{in, 4}^u$ и $\Omega_{in, 3}^d$. 
...
При этом две дуги, ограничивающие левую окружность верхнего цилиндра $\widetilde{\Omega}_1 \cup \widetilde{\Omega}_4$, проектируются в отрезок горизонтальной прямой, соединяющий левую вершину граничного эллипса с левым фокусом. В этот же отрезок проецируются дуги, ограничивающие левую окружность нижнего цилиндра  $\widetilde{\Omega}_1 \cup \widetilde{\Omega}_4$. Аналогично для $\widetilde{\Omega}_2$ и $\widetilde{\Omega}_3$. То же самое справедливо для дуг, ограничивающих правые окружности цилиндров, только проецируются они на симметричный горизонтальный отрезок от правого фокуса к правой вершине граничного эллипса.
...
\begin{figure}[!htb]
\centering
\includegraphics[width=0.4\textwidth]{images/ch4/section2/atoms/foc_ell_atom.pdf}
...
\minipage{0.45\textwidth}
\centering
\includegraphics[width=0.37\textwidth]{images/ch4/section2/atoms/atom_3_step.pdf}
    \caption{Склейка $\widetilde{\Omega}_1 \cup \widetilde{\Omega}_4$  \\ (перестройка 3).}
    \label{fig:pt9:_atom_3_step}
\endminipage\hfill
\minipage{0.55\textwidth}
\centering
\includegraphics[width=0.7\textwidth]{images/ch4/section2/atoms/atom_3.pdf}
...
На той же прямой можно выделить отрезки, которые соединяют правый (левый) фокус с правой  (левой) вершиной эллипса $Q_{\lambda_1}$. На каждый из этих отрезков проектируются границы областей $\Omega_{in, 1}^u, \Omega_{in, 2}^d, \Omega_{in, 1}^d, \Omega_{in, 2}^u$, аналогично для областей $\Omega_{in, 3}^u, \Omega_{in, 4}^d, \Omega_{in, 3}^d, \Omega_{in, 4}^u$.
...
\begin{figure}[!htb]
\centering
\includegraphics[width=0.4\textwidth]{images/ch4/section2/atoms/atom_4_domain.pdf}
...
соединяющий фокусы отрезок. Аналогичные склейки повторим для листов $\widetilde{\Omega}_2$ и  $\widetilde{\Omega}_3$. Результатом склеек являются две фигуры, каждая из которых является склейкой цилиндров с двумя дырками (гомеоморфных сферам с четыремя дырками) вдоль общей образующей (см. рис. \ref{fig:pt9:_atom_foc_hyp_iter1}).
...
\minipage{0.45\textwidth}
\centering
\includegraphics[width=0.43\textwidth]{images/ch4/section2/atoms/atom_foc_hyp_iter1.pdf}
...
\minipage{0.5\textwidth}
    \centering
\includegraphics[width=0.7\textwidth]{images/ch4/section2/atoms/atom_4.pdf}
...
\minipage{0.45\textwidth}
\centering
\includegraphics[width=0.9\textwidth]{images/ch4/section2/atoms/atom_5_domain.pdf}
    \caption{Пример области $\widetilde{\Omega}_1$ для перестройки 5.}
    \label{fig:pt9:_domain_atom_hyp_foc}
\endminipage\hfill
\minipage{0.45\textwidth}
\centering
\includegraphics[width=0.9\textwidth]{images/ch4/section2/atoms/atom_5_half.pdf}
...
\begin{figure}[!htb]
\centering
\includegraphics[width=0.4\textwidth]{images/ch4/section2/atoms/atom_5.pdf}
...
\begin{figure}[!htb]
\centering
\includegraphics[width=0.3\textwidth]{images/ch4/section2/atoms/atom_6.pdf}
...
\minipage{0.45\textwidth}
\centering
\includegraphics[width=0.35\textwidth]{images/ch4/section2/atoms/atom_8_step.pdf}
    \caption{Результат склейки \\ $\widetilde{\Omega}_1 \cup \widetilde{\Omega}_4$ для перестройки 8.}
    \label{fig:pt9:_atom_8_step}
\endminipage\hfill
\minipage{0.55\textwidth}
\centering
\includegraphics[width=0.7\textwidth]{images/ch4/section2/atoms/atom_8.pdf}
...
\minipage{0.45\textwidth}
\centering
\includegraphics[width=0.4\textwidth]{images/ch4/section2/atoms/atom_9_step.pdf}
\caption{Результат склейки \\ $\widetilde{\Omega}_1 \cup \widetilde{\Omega}_4$ для перестройки 9.}
\label{fig:pt9:_atom_9_step}
\endminipage\hfill
\minipage{0.5\textwidth}
\centering
\includegraphics[width=0.85\textwidth]{images/ch4/section2/atoms/atom_9.pdf}
...
Эта перестройка совпадает с перестройкой $\alpha_{out} \to b^2$ классического бильярда в эллиптическом кольце $\Omega_{out}$. Перестройка подробно разобрана в \cite[\S 3]{fokicheva2015topological}.
...
Следовательно, такая перестройка возможна лишь в случае $n_{in}^2 = n_{out}^2$, что соответствует отсутствию преломления. Такая перестройка рассматривается в теории классического бильярда, см. \cite[\S 3]{fokicheva2015topological}.
...
\centering
\includegraphics[width=0.8\textwidth]{images/ch4/section2/atoms/atom_12_half.pdf}
    \caption{Схема склейки $\Omega_1 \cup \Omega_4$ и $\Omega_2 \cup \Omega_3$ для случая 12.}
    \label{fig:pt9:_atom_12_half}
\endminipage\hfill
\minipage{0.47\textwidth}
\centering
\includegraphics[width=0.7\textwidth]{images/ch4/section2/atoms/atom_12.pdf}
...
\minipage{0.47\textwidth}
\centering
\includegraphics[width=0.6\textwidth]{images/ch4/section2/atoms/atom_13_half.pdf}
    \caption{Схема склейки $\Omega_1 \cup \Omega_2$ и $\Omega_3 \cup \Omega_4$ для случая 13.}
    \label{fig:pt9:_atom_13_half}
\endminipage\hfill
\minipage{0.47\textwidth}
\centering
\includegraphics[width=0.6\textwidth]{images/ch4/section2/atoms/atom_13.pdf}
