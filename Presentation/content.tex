...
\begin{frame}
    ...
    \centering
    \includegraphics[width=0.8\linewidth]{images/logo} % окружение figure не требуется
\end{frame}
...
\begin{frame}
    ...
    \centering
    \vfill
    \includegraphics[width=0.8\linewidth,height=0.1\textheight]{images/logo} \\
    \TeX
    \vfill
    \includegraphics[width=0.8\linewidth,height=0.2\textheight]{images/logo} \\
    \LaTeX
    \vfill
...
\begin{frame}
    ...
    \begin{minipage}[t]{0.47\linewidth}
        ...
        \center{\includegraphics[width=1\linewidth]{images/logo}}
    \end{minipage}
    \hfill
    \begin{minipage}[t]{0.47\linewidth}
...
\begin{frame}
    ...
    \centering
    \includegraphics[width=0.35\linewidth,angle=35]{images/logo}
    \includegraphics[width=0.35\linewidth,angle=135]{images/logo}\\
    \includegraphics[width=0.35\linewidth,angle=15]{images/logo}
    \includegraphics[width=0.35\linewidth,angle=-15]{images/logo}
\end{frame}
