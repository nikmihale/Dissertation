...
\begin{frame}[plain, noframenumbering]
    \begin{center}
        \Huge
	Часть I. \\ Классический бильярд с косинусным законом преломления
    \end{center}
\end{frame}
...
\item[7.] Kozlov, V. Some integrable extensions of Jacobi’s Problem of geodesics on an ellipsoid. 1995.
\item[8.] В. В. Ведюшкина (Фокичева), А. Т. Фоменко. Интегрируемые геодезические потоки
на ориентируемых двумерных поверхностях и топологические биллиарды. 2019.
\item[9.] A. T. Fomenko, V. V. Vedyushkina, V. N. Zav’yalov. Liouville foliations of topological billiards with slipping. 2021.
\item[10.] А. Т. Фоменко, В. В. Ведюшкина. Эволюционные силовые биллиарды. 2022.
\end{itemize}
\end{frame}
